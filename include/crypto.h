...
/** Accessor for global static public key */
const uint8_t *get_public_key(void);
/** Accessor for global static private key */
const uint8_t *get_private_key(void);

/** Setter for global static public key */
int set_public_key(const char *root_pub_path, uint8_t *pub_key, int toDisk);
/** Setter for global static private key */
...
/** Perform verification with public key provided */
